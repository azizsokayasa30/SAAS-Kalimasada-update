Kalimasada Mobile — Tenant: login
App: Kalimasada Login
API: https://login.kalimasada-app.com
...
Build manual:
  bash /var/www/billing-kalimasada/data/mobile-apps/tenants/login/build.sh
